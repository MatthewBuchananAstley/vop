...
vop - A program to generate quantum safe passwords 

# SYNOPSIS

**vop** **-s** 'Number of special characters' 'pw_length' '1 (for base64 encoding)'
...
**-s** 10 100
:   creates a password of 100 characters with 10 special characters interspersed.
...
/usr/bin/t3
:   A tool to generate a password using the full character set 

/usr/bin/Password_entropy_verifier.py
:   A tool to verify the amount of entropy for quantum safety.
    Usage: ./Password_entropy_veryfier.py $(./[t3|vop] 'pw_length')

/usr/bin/pw
:   A tool to have vop print out a list of passwords.
    Usage: ./pw [vop|t3] 'pw length' 

# BUGS

If you encounter a bug, please let me know via the follwing page:

https://github.com/MatthewBuchananAstley/vop/security/advisories/new

# AUTHOR

Matthew Buchanan Astley <linux@astley.nl>
:   Wrote this manpage for the Debian system.

# COPYRIGHT

Copyright ©2022-2025 Matthew Buchanan Astley 
